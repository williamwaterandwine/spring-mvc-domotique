 ...
 * @author usrlocal
 */
public class WritePinValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (arduino.getValue() == null) {
            errors.rejectValue("value", "200", "Vous devez renseigner une valeur (0 ou 1).");
        } else if (arduino.getValue() != 0 && arduino.getValue() != 1) {
            errors.rejectValue("value", "201", "La valeur doit être 0 ou 1 (allumer ou éteindre).");
